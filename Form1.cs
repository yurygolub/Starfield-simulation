...
namespace WindowsFormsApp4
{
    public partial class Form1 : Form
    {
        ...
        private void DrawStar(Star star)
        {
            ...
            if (temp > 75)
            {
                graphics.FillEllipse(Brushes.Green, x, y, starSize, starSize);
            }
            else if(temp > 50)
            {
                graphics.FillEllipse(Brushes.Red, x, y, starSize, starSize);
            }
            else if (temp > 25)
            {
            ...
            {
                graphics.FillEllipse(Brushes.Yellow, x, y, starSize, starSize);
            }
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < stars.Length; i++)
            {
                stars[i] = new Star()
                {
                    X = rand.Next(-pictureBox1.Width, pictureBox1.Width),
                    Y = rand.Next(-pictureBox1.Height, pictureBox1.Height),
                    Z = rand.Next(1, pictureBox1.Width)
                };
            }
